...
inline StringViewWrapper<UTFCharType, CaseSensitive, UTFCharTypeTraits>::StringViewWrapper(const StringWrapper<UTFCharTypeInput, CaseSensitiveInput, UTFCharTypeTraitsInput, UTFAllocatorInput>& other)
  : StringViewWrapper{ std::basic_string_view<UTFCharTypeInput>(other.native()), true }
{}

template <typename UTFCharType, bool CaseSensitive, typename UTFCharTypeTraits>
requires IsUTFCharType<UTFCharType>
[[nodiscard]] inline std::filesystem::path StringViewWrapper<UTFCharType, CaseSensitive, UTFCharTypeTraits>::path() const
{
