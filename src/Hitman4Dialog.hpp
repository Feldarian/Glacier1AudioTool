...
struct Hitman4WHDFile
{
  ...
  bool Load(StringView8CI basePath, std::set<String8CI>& archivePaths, std::map<StringView8CI, HitmanFile>& fileMap, std::map<StringView8CI, std::vector<Hitman4WHDRecord *>>& whdRecordsMap);
