...
struct Hitman4WAVFile
{
  ...
  bool Load(const std::filesystem::path &loadPath, const UTFViewToTypeMapCI<wchar_t, Hitman4WHDRecord *> &whdRecordsMap,
...
struct Hitman4WHDFile
{
  ...
  bool Load(const std::filesystem::path &basePath, PathSetCI& archivePaths, UTFViewToTypeMapCI<wchar_t, HitmanFile>& fileMap, UTFViewToTypeMapCI<wchar_t, std::vector<Hitman4WHDRecord *>>& whdRecordsMap);

  bool Save(const Hitman4WAVFile &streamsWAV, const Hitman4WAVFile &missionWAV, const std::filesystem::path &savePath);

  Hitman4WHDHeader *header = nullptr;
  UTFViewToTypeMapCI<wchar_t, Hitman4WHDRecord *> recordMap;
...
public:
  ...
  UTFViewToTypeMapCI<wchar_t, std::vector<Hitman4WHDRecord *>> whdRecordsMap;
